...
/datum/reagent/impurity
	...
	chemical_flags = REAGENT_DONOTSPLIT | REAGENT_CAN_BE_SYNTHESIZED //impure can be synthed, and is one of the only ways to get almost pure impure
	ph = 3
	inverse_chem = null
	inverse_chem_val = 0
...
/datum/reagent/inverse
	...
	ph = 2
	chemical_flags = REAGENT_DONOTSPLIT //Inverse generally cannot be synthed - they're difficult to get
